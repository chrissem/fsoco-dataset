...
from .labelstudio2sly import main


@click.command()
@click.argument("images_folder", type=str)
@click.argument("ls_labels_file", type=str)
...
def labelstudio2sly(
    images_folder, ls_labels_file, out_path, project_name, dataset_name
):
    """
    ...
    """
    click.echo("[LOG] Running Labelstudio to Supervisely label converter")
    main(images_folder, ls_labels_file, out_path, project_name, dataset_name)
